 ...
 *
 * Also redirects requests for /chunk-ABCDEF.js to
 * apps/backend/chunk-ABCDEF.js where ABCDEF is a hash code generated by
 * the Angular compiler and apps/backend is deftived from File.
 * 
 * \code{.cpp}
