...
export class JobqueueBackendComponent implements OnInit, AfterViewInit {
    ...
    @ViewChild("jobqbackend") currentForm!: NgForm;
    @ViewChild("JobQueueWindowStartHT") JobQueueWindowStartHT!: DatePicker;
    @ViewChild("JobQueueWindowEndHT") JobQueueWindowEndHT!: DatePicker;
