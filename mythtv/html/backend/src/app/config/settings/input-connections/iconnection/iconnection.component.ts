...
import { CardAndInput, CaptureCardList, InputGroup, DiseqcTreeList, DiseqcTree, DiseqcConfig, CaptureDeviceList, CaptureDevice } from '../../../../services/interfaces/capture-card.interface';
import { Channel, FetchChannelsFromSourceRequest, GetChannelInfoListRequest } from '../../../../services/interfaces/channel.interface';
...
export class IconnectionComponent implements OnInit, AfterViewInit {
    ...
    // parent
    @Input() parent!: InputConnectionsComponent;
